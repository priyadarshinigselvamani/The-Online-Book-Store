...
<div class="container-xl">
	<div class="table-responsive">
		<div class="table-wrapper">
            ...
            <form id="brokersform" action="{{url('/update_book/'. $book->id)}}" method='POST' autocomplete='off' enctype="multipart/form-data">
                {{csrf_field() }}
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <input type="text" required class="form-control" id="description" name='description' value="{{$book->description}}"/>
                              </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="date" class="form-control" id="publishedon" name='publishedon' value="{{$book->published_on}}"/>
                            </div>
                        </div>
                      </div>
                      <div class="col-md-6">
